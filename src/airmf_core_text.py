"""
Canonical AI RMF Core text for the GOVERN function.

Source: NIST AI Risk Management Framework (AI RMF 1.0), AI RMF Core Section 5,
"Govern" function, Table 1 (Categories and subcategories for the GOVERN
function). Reproduced verbatim from
...
Why this lives here and not derived from playbook.json: the Playbook JSON
export at https://airc.nist.gov/docs/playbook.json carries minor textual
deviations from the AI RMF Core canonical text, including at least one typo
(GOVERN 3.1: "Decision-makings" vs Core "Decision-making") and one semantic
divergence (GOVERN 5.2 in Playbook says "AI actors", Core says "the team
that developed or deployed AI systems"). Compliance work cites the Core,
so the catalog statements must come from the Core.
...
NIST changes wording without an explicit update here.

Last verified against AIRC: 2026-05-10
"""

# 6 GOVERN category statements, verbatim from AI RMF Core Table 1.
GOVERN_CATEGORIES = {
...
# 19 GOVERN subcategory statements, verbatim from AI RMF Core Table 1.
