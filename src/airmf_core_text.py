"""
Canonical AI RMF Core text for all four functions.

Source: NIST AI Risk Management Framework (AI RMF 1.0), AI RMF Core Section 5,
Tables 1 (GOVERN), 2 (MAP), 3 (MEASURE), 4 (MANAGE). Reproduced verbatim from
https://airc.nist.gov/airmf-resources/airmf/5-sec-core/

NIST publications are works of the U.S. Government and not subject to
copyright in the United States. This file is reproduced under that public
domain status.

Why this lives here and not derived from playbook.json: a 2026-05-10 audit
of the AI RMF Playbook JSON export (https://airc.nist.gov/docs/playbook.json)
against the AI RMF Core HTML rendering found 41 of 72 subcategory descriptions
(57 percent) drift from the canonical Core text. Examples include a typo at
GOVERN 3.1 ("Decision-makings" vs Core "Decision-making"), a semantic
divergence at GOVERN 5.2 ("AI actors" vs Core "the team that developed or
deployed AI systems"), and capitalisation inconsistencies between the
Playbook (e.g. "MAP function") and the Core (e.g. "map function"). Compliance
work cites the Core, so the catalog must come from the Core.

Verification: a CI check in tests/test_core_text_drift.py compares the
constants below against a fresh fetch of the AIRC Core HTML and fails if
NIST changes wording without an explicit update here. The drift inventory
between Playbook and Core is recorded in source/ATTRIBUTION.md.

Last verified against AIRC Core: 2026-05-10
Total: 19 categories, 72 subcategories
"""

# =====================================================================
# GOVERN function (6 categories, 19 subcategories)
# =====================================================================
...
GOVERN_SUBCATEGORIES = {
    "1.1": "Legal and regulatory requirements involving AI are understood, managed, and documented.",
    "1.2": "The characteristics of trustworthy AI are integrated into organizational policies, processes, procedures, and practices.",
    "1.3": "Processes, procedures, and practices are in place to determine the needed level of risk management activities based on the organization's risk tolerance.",
    ...
    "1.5": "Ongoing monitoring and periodic review of the risk management process and its outcomes are planned and organizational roles and responsibilities clearly defined, including determining the frequency of periodic review.",
    ...
    "3.1": "Decision-making related to mapping, measuring, and managing AI risks throughout the lifecycle is informed by a diverse team (e.g., diversity of demographics, disciplines, experience, expertise, and backgrounds).",
    ...
    "4.2": "Organizational teams document the risks and potential impacts of the AI technology they design, develop, deploy, evaluate, and use, and they communicate about the impacts more broadly.",
...
# =====================================================================
# MAP function (5 categories, 18 subcategories)
# =====================================================================
...
MAP_SUBCATEGORIES = {
    ...
    "1.2": "Interdisciplinary AI actors, competencies, skills, and capacities for establishing context reflect demographic diversity and broad domain and user experience expertise, and their participation is documented. Opportunities for interdisciplinary collaboration are prioritized.",
    "1.3": "The organization’s mission and relevant goals for AI technology are understood and documented.",
    ...
    "1.6": "System requirements (e.g., “the system shall respect the privacy of its users”) are elicited from and understood by relevant AI actors. Design decisions take socio-technical implications into account to address AI risks.",
    ...
    "2.2": "Information about the AI system’s knowledge limits and how system output may be utilized and overseen by humans is documented. Documentation provides sufficient information to assist relevant AI actors when making decisions and taking subsequent actions.",
    "2.3": "Scientific integrity and TEVV considerations are identified and documented, including those related to experimental design, data collection and selection (e.g., availability, representativeness, suitability), system trustworthiness, and construct validation.",
...
# =====================================================================
# MEASURE function (4 categories, 22 subcategories)
# =====================================================================
...
MEASURE_SUBCATEGORIES = {
    "1.1": "Approaches and metrics for measurement of AI risks enumerated during the map function are selected for implementation starting with the most significant AI risks. The risks or trustworthiness characteristics that will not – or cannot – be measured are properly documented.",
    ...
    "2.9": "The AI model is explained, validated, and documented, and AI system output is interpreted within its context – as identified in the map function – to inform responsible use and governance.",
    "2.10": "Privacy risk of the AI system – as identified in the map function – is examined and documented.",
    "2.11": "Fairness and bias – as identified in the map function – are evaluated and results are documented.",
    ...
    "4.2": "Measurement results regarding AI system trustworthiness in deployment context(s) and across the AI lifecycle are informed by input from domain experts and relevant AI actors to validate whether the system is performing consistently as intended. Results are documented.",
...
# =====================================================================
# MANAGE function (4 categories, 13 subcategories)
# =====================================================================
...
MANAGE_SUBCATEGORIES = {
    ...
    "1.3": "Responses to the AI risks deemed high priority, as identified by the map function, are developed, planned, and documented. Risk response options can include mitigating, transferring, avoiding, or accepting.",
    ...
    "2.4": "Mechanisms are in place and applied, and responsibilities are assigned and understood, to supersede, disengage, or deactivate AI systems that demonstrate performance or outcomes inconsistent with intended use.",
...
# =====================================================================
# Combined accessors for convenience
# =====================================================================

ALL_CATEGORIES = {
    "GOVERN": GOVERN_CATEGORIES,
    "MAP": MAP_CATEGORIES,
...
ALL_SUBCATEGORIES = {
    "GOVERN": GOVERN_SUBCATEGORIES,
    "MAP": MAP_SUBCATEGORIES,
    "MEASURE": MEASURE_SUBCATEGORIES,
    "MANAGE": MANAGE_SUBCATEGORIES,
}

# Convenience: function name -> short prefix for OSCAL IDs
FUNCTION_PREFIXES_FALLBACK = {
    "GOVERN": "gv",
    "MAP": "mp",
    "MEASURE": "ms",
    "MANAGE": "mg",
